...
|---|---|---|---|---|---|---|---|---|
| `ENH-0.1.0-alpha42-project-conversation-title` | `DEV-conversation-recognition` | `0.1.0-alpha42-project-conversation-title`; Actions pending | `feat/conversation-recognition`; Draft PR #2 → `feat/chatgpt-enhancer-v0.1` | Reserved after alpha41 post-build state-ownership review; branch bookkeeping head before alpha42 edits `96853959eaa175a437ae09b6eb8025f965b55f02`, functional isolation commit already present `9966628eb86d6e60f5cc642e792ee3cc6bf63f6e` | Candidate reserved; final code/CI/artifact pending | Pending | Pending | Reserved candidate |
