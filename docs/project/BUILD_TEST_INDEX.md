...
|---|---|---|---|---|---|---|---|---|
| `ENH-0.1.0-alpha45-visible-button-guard` | `DEV-conversation-recognition` | `0.1.0-alpha45-visible-button-guard`; build pending | `feat/conversation-recognition`; Draft PR #2 → `feat/chatgpt-enhancer-v0.1` | Reserved from alpha44 runtime failure; pre-change branch head `a4414cbdd5466cd7bb3d660f43039204dfb052dd` | Pending code/CI/artifact | Pending | Pending. Acceptance: floating button visible independently of identity proof; guarded actions still target visible conversation or refuse, never another conversation. | Reserved candidate |
