...
|---|---|---|---|---|---|---|---|---|
| `ENH-0.1.0-alpha45-visible-button-guard` | `DEV-conversation-recognition` | `0.1.0-alpha45-visible-button-guard`; Actions `32939338703` | `feat/conversation-recognition`; Draft PR #2 → `feat/chatgpt-enhancer-v0.1` | Build/test source `037b4aba99b45f30e04a8f9714231a545a0137c2`; CI bookkeeping `f28c7f56cfaea48f35cb98ecb20490686f36b54f`; current head `c902d0f1a76d65dd3ba2232dd88eae2b1ac269d8` (workflow-trigger cleanup only) | Code written; CI passed; Artifact produced | package id `9595962373`, digest `sha256:04e46a8f48643fee95968161798b74a8cb7b963beeadc0e2fab14a339fbeb839`; dylib id `9595962949`, digest `sha256:7868dbe9a0ba84ae0985bb8cea2c136640a5b6c13e7b1b5596a11982e2e97c59` | Runtime/manual pending. Acceptance: floating button visible independently of identity proof; guarded actions still target visible conversation or refuse, never another conversation. | Candidate |
