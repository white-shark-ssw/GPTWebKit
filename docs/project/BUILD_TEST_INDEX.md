...
|---|---|---|---|---|---|---|---|---|
| `ENH-0.1.0-alpha43-conversation-usage` | `DEV-conversation-usage` | `0.1.0-alpha43-conversation-usage`; final-source Actions `32857881847` | `feat/conversation-usage`; Draft PR #3 → `feat/conversation-recognition` (stacked on alpha42) | stacked merge `4662fda538fe01e6d5a4530cecde1a249b09e089`; fully synchronized candidate source head `41749c039d0ef8a8a7f8e89e6e3508d4d9de3dae` | Code written; final-source CI in progress | Pending | Pending | Candidate building |
