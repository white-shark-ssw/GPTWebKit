...
|---|---|---|---|---|---|---|---|---|
| `ENH-0.1.0-alpha49-exact-rename-ui-target` | `DEV-conversation-recognition` | `0.1.0-alpha49-exact-rename-ui-target`; Actions `32980682467`; job `98216287227` | `feat/conversation-recognition`; Draft PR #2 → `feat/chatgpt-enhancer-v0.1` | Build/test source `3f3a04715e93755c1c04b4ca826aad2488c2a9a1`; CI bookkeeping `0e1bb6a72bc41f05ff5addceeffa3164c413b817`; post-CI cleanup head `9534ddb77bc43a979e34bd69b040d85ff38501dd` | Code written; CI passed; Artifact produced; Runtime/manual pending | package id `9611305133`, digest `sha256:f3ec7f8c11e9acc268d6441f536ee54691a5be9d3e7247149dba7627341c6d30`; dylib id `9611306138`, digest `sha256:3d9bc9699a1a55aba5cd868f00f064707a63d014dca9a17c37e788607057c214` | Pending. Restores exact-ID current-menu Rename with final pre-PATCH context guard; project-header and Reload UI target discovery now search visible foreground-scene windows instead of only the transient key window. No generation-recovery behavior changed. | Current candidate |
