...
static void CEShowLoadedToastWhenReady(NSUInteger attempt) {
    if (CEKeyWindow()) { CEShowToast(@"ChatGPTEnhancer alpha10 已加载"); return; }
...
static void CEStartEnhancer(void) {
    ...
    @try {
        ...
        NSLog(@"[ChatGPTEnhancer] alpha10 started for %@ %@", NSBundle.mainBundle.bundleIdentifier, [NSBundle.mainBundle objectForInfoDictionaryKey:@"CFBundleShortVersionString"] ?: @"unknown");
