...
static void CEShowLoadedToastWhenReady(NSUInteger attempt) {
    if (CEKeyWindow()) { CEShowToast(@"ChatGPTEnhancer alpha12 已加载"); return; }
...
static void CEStartEnhancer(void) {
    ...
    @try {
        ...
        NSLog(@"[ChatGPTEnhancer] alpha12 started for %@ %@", NSBundle.mainBundle.bundleIdentifier, [NSBundle.mainBundle objectForInfoDictionaryKey:@"CFBundleShortVersionString"] ?: @"unknown");
