...
cp "$ROOT/Support/ChatGPTEnhancer.plist" "$BUILD/package/ChatGPTEnhancer.plist"
cp "$ROOT/README.md" "$BUILD/package/README.txt"
(cd "$BUILD/package" && /usr/bin/zip -9 -r "../ChatGPTEnhancer-0.1.0-alpha46-conversation-identity-trace.zip" .)
file "$BUILD/ChatGPTEnhancer.dylib"
ls -lh "$BUILD/ChatGPTEnhancer.dylib" "$BUILD/ChatGPTEnhancer-0.1.0-alpha46-conversation-identity-trace.zip"
