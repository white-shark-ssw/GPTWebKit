...
(cd "$BUILD/package" && /usr/bin/zip -9 -r "../ChatGPTEnhancer-0.1.0-alpha56-navigation-instance-trace.zip" .)
file "$BUILD/ChatGPTEnhancer.dylib"
ls -lh "$BUILD/ChatGPTEnhancer.dylib" "$BUILD/ChatGPTEnhancer-0.1.0-alpha56-navigation-instance-trace.zip"