...
(cd "$BUILD/package" && /usr/bin/zip -9 -r "../ChatGPTEnhancer-0.1.0-alpha44-current-conversation-guard.zip" .)
file "$BUILD/ChatGPTEnhancer.dylib"
ls -lh "$BUILD/ChatGPTEnhancer.dylib" "$BUILD/ChatGPTEnhancer-0.1.0-alpha44-current-conversation-guard.zip"
